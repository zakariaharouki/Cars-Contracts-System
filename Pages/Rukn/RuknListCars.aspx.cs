...
{
    public partial class RuknListCars : System.Web.UI.Page
    {
        ...
        protected void Deletebtn_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/RuknListCars");
        ...
        protected void Editbtn_Click(object sender, EventArgs e)
        {
            LinkButton btn = (LinkButton)sender;
            int CarID = int.Parse(btn.CommandArgument);
            Response.Redirect("RuknEditCar/" + CarID);
        ...
        {
            Cars cars = new Cars();
            rptCars.DataSource = cars.getCarsRukn();
            rptCars.DataBind();
        }
    }
}